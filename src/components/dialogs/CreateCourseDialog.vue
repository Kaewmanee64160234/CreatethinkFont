            ...
            <v-card style="width: 30vw;">
                ...
                <v-card variant="outlined" class="cards textarea">
                    <v-card-title>
                        ...
                        <v-text-field clearable label="สร้างชื่อรายวิชา" variant="outlined"
                            class="colorText"></v-text-field>
                    </v-card-title>
                </v-card>
                <v-card variant="outlined" class="cards textarea">
                    <v-card-title>
                        ...
                        <v-text-field clearable label="รหัสห้องเรียน" variant="outlined"
                            class="colorText"></v-text-field>
                    </v-card-title>
                </v-card>
                <v-card-actions class="actions">
                    <v-btn @click="courseStore.closeDialog">ยกเลิก</v-btn>
                    <v-btn @click="openDialog2" class="colorText">ต่อไป</v-btn>
                </v-card-actions>
