...
<template>
  <div class="centered-container" style="background-color: antiquewhite;">
    <v-card class="light-gray-card" style="text-align: center; padding-top: 40pt; " width="50vw" height="52vh">
      ...
      <div v-else>
        <h1 style="text-align: center;">Welcome, {{ authStore.currentUser?.firstName + ' ' +
        authStore.currentUser?.lastName }}</h1>
...
.centered-container {
  ...
  align-items: center;
  height: 100vh;
  /* This will make the container cover the entire viewport height */
}
