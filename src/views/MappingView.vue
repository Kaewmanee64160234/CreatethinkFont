...
async function handleImageUpload(
  event: Event,
  descriptorsRef: { value: Float32Array[] }
) {
...
function performComparison() {
  ...
  const match = secondImageDescriptors.value.some(
